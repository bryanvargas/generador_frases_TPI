...
//		Set Up mnemoc
		...
		$nombresLabel.setDisplayedMnemonic(KeyEvent.VK_N);
		$nombresLabel.setLabelFor(nameField);
		...
		ageModel.addElement(new Category(2,"65 or over"));
		...
		okBtn.addActionListener(new ActionListener() {			
			...
			public void actionPerformed(ActionEvent e) {
				...
				Category ageCat = (Category)ageList.getSelectedValue();
