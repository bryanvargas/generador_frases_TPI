...
public class PrintAction implements Printable {
	...
	private final FrasesPanel jTextArea;    //área de edición donde se encuentra el documento actual
    ...
    public PrintAction(FrasesPanel messagePanel) {
        this.jTextArea = messagePanel;   //guarda la instancia del área de edición
    }
